      ...
      <form action="code.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <label> CONTACT</label>
                <input type="text" name="contact" class="form-control" placeholder="Enter title">
            </div>
            <div class="form-group">
                <label>SOCIAL MEDIA</label>
                <input type="text" name="smedia" class="form-control " placeholder="Enter subtitle">
...
?>
    <tr>
        ...
        <td><?php echo'
    <img src="upload/'. $row['image'].'" width="100px" height="100px" alt="Image">'?>
</td>
